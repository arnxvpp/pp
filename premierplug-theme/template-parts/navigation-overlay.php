    ...
    <div class="menu-container">
        <nav class="global-nav">
            ...
            if (has_nav_menu('primary')) {
                ...
                ?>
                <ul>
                    <li><a href="#" title="Research" target="_self">Research</a>
                        <ul>
                    ...
                    <li><a href="#" title="For Talents" target="_self">For Talents</a>
                        <ul>
                    ...
                    <li><a href="#" title="For Enterprise" target="_self">For Enterprise</a>
                        <ul>
                            <li><a href="#" title="Partnership Sales" target="_self">Partnership Sales</a>
                                <ul>
                                    ...
                                    <li><a href="<?php echo esc_url(home_url('/touring')); ?>" title="Music and Comedy Touring" target="_self" class="linkTo long-link">Music &amp; Comedy Touring</a></li>
                                    <li><a href="<?php echo esc_url(home_url('/merchandising')); ?>" title="Entertainment Endorsements and Voiceovers" target="_self" class="linkTo long-link">Merchandising</a></li>
                                </ul>
                            </li>
                            <li><a href="#" title="Brand Solutions" target="_self">Brand Solutions</a>
                                <ul>
                                    ...
                                    <li><a href="<?php echo esc_url(home_url('/brand-management')); ?>" title="Brand Management" target="_self" class="linkTo">Brand Management</a></li>
                                    ...
                                    <li><a href="<?php echo esc_url(home_url('/marketing-it')); ?>" title="Marketing and IT" target="_self" class="linkTo">Marketing &amp; IT</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
        ...
        <div class="overlay-footer">
            <div class="homepage-ft">
                ...
                if (has_nav_menu('footer')) {
                    ...
                    <nav>
                        <ul>
                            <li><a href="<?php echo esc_url(home_url('/about-us')); ?>" title="About">About</a></li>
