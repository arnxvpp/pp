 ...
 * Description: Template for research segment pages (Social, Market, Data Analysis)
 *
 * @package PremierPlug
 */
...
<div id="main">
    <section id="content">
        ...
        <?php while (have_posts()) : the_post(); ?>
                ...
                <section class="hero-container full_vh var1 bg-black mask-out" id="hero-carousel">
                    <div class="hero-text-container vertical-align">
                        <div class="gutter-container">
                            <header>
                                <div class="h8" data-aos="fade-up" data-aos-once="true" data-aos-delay="600">Research</div>
                            </header>
            ...
            $related_args = array(
                'post_type' => 'post',
                'category_name' => 'research-services',
                'posts_per_page' => 3,
            ...
            ?>
                <section class="related-services pad-tb bg-light">
                    <div class="gutter-container">
                        <header>
                            <div class="h8" data-aos="fade-up">Related Research Services</div>
                        </header>
